...
- [ ] Map each grade to its available Practice and Study Materials content
- [ ] Merge the navigation logo into the navigation background
- [ ] Restore a visible atom animation on the grade-selection page
